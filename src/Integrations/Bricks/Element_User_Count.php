<?php
/**
 * Bricks element: User Favorite Count.
 *
...
/**
 * User Favorite Count element for Bricks Builder.
 */
class Element_User_Count extends \Bricks\Element {

    /** @var string */
    public $category = 'favorites';

    /** @var string */
    public $name = 'wpef-user-count';
    ...
    public function get_label(): string {
        return esc_html__('User Favorite Count', 'wpef');
    }

    /** @return string[] */
    public function get_keywords(): array {
        return ['favorite', 'count', 'user', 'total', 'wpef'];
    }
    ...
    public static function render_builder(): void {
        ?>
        <script type="text/x-template" id="tmpl-bricks-element-wpef-user-count">
            <span class="wpef-count wpef-count--user">
